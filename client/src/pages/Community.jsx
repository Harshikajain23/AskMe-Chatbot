...
/>
      ...
      {images.length > 0 ? (
        ...
        {images.map((item, index)=>(
          <a key={index} href={item.imageUrl} target='_blank' className='relative group block rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-300'>
        ...
        <p className='text-center text-gray-600 dark:text-gray-200 mt-10'> No images Available.</p>
      )}
