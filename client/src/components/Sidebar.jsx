...
> 
      ...
      <button onClick={handleNewChat} className='flex justify-center items-center w-full py-2 mt-1 text-white bg-gradient-to-r from-[#424849] to-[#bac2ce] text-sm rounded-md cursor-pointer' >
